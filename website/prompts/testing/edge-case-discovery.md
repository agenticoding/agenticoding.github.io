...
- **[Lesson 8: Spec-Driven Development](/practical-techniques/lesson-8-spec-driven-development#require-evidence-to-force-grounding)** - Research-first methodology, evidence requirements
- **[Lesson 9: Tests as Guardrails](/practical-techniques/lesson-9-tests-as-guardrails#the-three-context-workflow)** - Three-context workflow, preventing specification gaming
