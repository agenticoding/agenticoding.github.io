...
- **[Lesson 8: Spec-Driven Development](/practical-techniques/lesson-8-spec-driven-development#require-evidence-to-force-grounding)** - Evidence requirements, grounding techniques
- **[Lesson 9: Tests as Guardrails](/practical-techniques/lesson-9-tests-as-guardrails#test-failure-diagnosis-agent-driven-debug-cycle)** - Three-context workflow, test failure diagnosis
