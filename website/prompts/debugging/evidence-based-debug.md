...
- **[Lesson 8: Spec-Driven Development](/practical-techniques/lesson-8-spec-driven-development#require-evidence-to-force-grounding)** - Evidence requirements, challenging agent logic
- **[Lesson 11: Debugging](/practical-techniques/lesson-11-debugging#the-closed-loop-debugging-workflow)** - Closed-loop workflow, reproduction scripts, evidence-based approach
