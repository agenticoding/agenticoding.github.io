...
- **[Lesson 3: High-Level Methodology](/methodology/lesson-3-high-level-methodology#the-four-phase-workflow)** - Four-phase workflow (Research > Plan > Execute > Validate), iteration decisions
- **[Lesson 4: Prompting 101](/methodology/lesson-4-prompting-101#applying-structure-to-prompts)** - Structured prompting, constraints as guardrails, information density
- **[Lesson 5: Grounding](/methodology/lesson-5-grounding#production-pattern-multi-source-grounding)** - Multi-source grounding with ChunkHound code research and web search, semantic search, sub-agents
- **[Lesson 6: Context Management](/practical-techniques/lesson-6-context-management#context-files-claudemd--agentsmd)** - Context files, tools & discovery, skills, runtime context management
