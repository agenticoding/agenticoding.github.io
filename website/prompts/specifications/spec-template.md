...
1. Start with Architecture + Interfaces + State, then add sections as the code pulls them
   (see [Converge, Don't Count Passes](/practical-techniques/lesson-12-systems-thinking-specs#converge-dont-count-passes))
...
- [Lesson 12: Thinking in Systems](/practical-techniques/lesson-12-systems-thinking-specs) — explains the reasoning behind each section
- [Lesson 7: Spec-Driven Development](/practical-techniques/lesson-7-spec-driven-development) — the spec lifecycle
