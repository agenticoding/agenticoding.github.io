...
const BULLETS = [
  ...
  },
  {
    ...
    description:
      'by delegating log analysis, root cause investigation, and diagnostic scripts to agents',
  },
  {
    icon: MagnifyEmoji,
    label: 'Review code without confirmation bias',
    description:
      '— fresh context, evidence-based validation, no line-by-line slog',
  },
  {
    icon: RobotEmoji,
    label: 'Plan and execute features',
    description:
      'with parallel sub-agents across isolated branches and contexts',
  },
  {
    icon: RulerEmoji,
    label: 'Architect agent-friendly codebases',
    description:
      'where constraints are co-located with code and good patterns compound',
  },
  {
    icon: BrushEmoji,
    label: 'Generate complete design systems',
    description:
      'from computed first principles — brand palettes, typography scales, spatial grids, and illustrations derived by code rather than guessed',
  },
] as const;
