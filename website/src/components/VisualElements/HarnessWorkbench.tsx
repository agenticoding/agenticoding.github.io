...
const ARIA_LABEL =
  'Harness agent flow inside one root harness context: the human sets generic guardrails, the LLM chooses most tool-loop turns, use-case tools execute, and the human reviews or redirects the result.';
...
export default function HarnessWorkbench() {
  return (
    <ResponsiveDiagram
