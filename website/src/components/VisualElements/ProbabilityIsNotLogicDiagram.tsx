...
const ARIA_LABEL =
  'Comparison of logical derivation with probabilistic token prediction: premises and rules entail a conclusion on a straight path, while context tokens produce an artifact as the model-selected continuation along a zigzag likelihood path.';
...
function ProbabilityTokenTrain({
  start,
  end,
  axis,
  seed,
    ...
    <g aria-hidden="true">
      <g className={styles.logicRuleMotion} opacity="0">
        ...
        <animate
          ...
          dur="5.600s"
          repeatCount="indefinite"
          keyTimes="0;0.16;0.42;0.56;1"
        />
      </g>
      <g
        className={styles.logicRuleStatic}
        transform={`translate(${path.end.x} ${path.end.y})`}
      >
        <rect
          x="-4"
          y="-4"
  ...
  return (
    ...
    >
      ...
      <Tile
        ...
        title="Premises"
        meta="+ rules"
        className={styles.logicPremisePulse}
      />
      ...
      <Tile
        ...
        meta="entailed"
        tone="success"
        className={styles.logicConclusionPulse}
      />
      <text
        x={192}
        y={104}
      ...
      <Tile
        ...
        meta="tokens"
      />
      <ProbabilityTokenTrain
        start={{ x: 520, y: 148 }}
        end={{ x: 624, y: 148 }}
        axis="horizontal"
        seed="probability-is-not-logic-desktop"
      />
      <Tile
        x={632}
        y={DESKTOP_TILE_Y}
        ...
        meta="produced"
        tone="model"
        className={styles.probabilityOutputPulse}
      />
      <text
        x={572}
        y={104}
...
function MobileDiagram() {
  return (
    ...
    >
      ...
      />
      <Arrow
        d={`M 160 ${MOBILE_LOGIC.arrowStartY} V ${MOBILE_LOGIC.arrowEndY}`}
        markerId={MOBILE_ARROW_ID}
      />
      <LogicRuleSignal
        start={{ x: 160, y: MOBILE_LOGIC.arrowStartY }}
        end={{ x: 160, y: MOBILE_LOGIC.arrowEndY }}
        axis="vertical"
      />
      <Tile
        x={92}
        y={MOBILE_LOGIC.outputY}
        {...TILE_SIZE.mobile}
        title="Conclusion"
        meta="entailed"
        tone="success"
      ...
      <Tile
        x={92}
        y={MOBILE_PROBABILITY.inputY}
        {...TILE_SIZE.mobile}
        title="Context"
        meta="tokens"
      />
      <ProbabilityTokenTrain
        start={{ x: 160, y: MOBILE_PROBABILITY.pathStartY }}
        end={{ x: 160, y: MOBILE_PROBABILITY.pathEndY }}
        axis="vertical"
        seed="probability-is-not-logic-mobile"
      />
      <Tile
        x={92}
        y={MOBILE_PROBABILITY.outputY}
        {...TILE_SIZE.mobile}
        title="Artifact"
        meta="produced"
        tone="model"
