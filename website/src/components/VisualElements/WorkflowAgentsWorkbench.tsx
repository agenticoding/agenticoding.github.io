...
import styles from './WorkflowAgentsWorkbench.module.css';

const ARIA_LABEL =
  'Workflow agents: a trigger enters a code orchestrator; a code-owned workflow contains three bounded LLM calls for intent, answer, and citations; and an approval gate validates the result before commit.';
...
const TOKEN_PAIR = seededTokenTrain('workflow-agents-token', 2);
const CODE_PAIR = seededTokenTrain('workflow-agents-code', 2);
...
export default function WorkflowAgentsWorkbench() {
  return (
    <ResponsiveDiagram
