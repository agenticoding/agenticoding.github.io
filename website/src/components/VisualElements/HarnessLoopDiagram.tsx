...
const ARIA_LABEL =
  'Agent harness loop: assemble context, call the model, parse and validate output, execute outside the model, append observation, then stop or iterate.';
  ...
  return (
    <>
      <text
        x="70"
        y="32"
        className={clsx(styles.laneLabel, visible && styles.visible)}
      ...
      <line
        ...
        x2="164"
        y2="288"
        className={clsx(styles.boundary, visible && styles.visible)}
        stroke="var(--border-default)"
        strokeDasharray="4 4"
      />
      <line
  ...
  return (
    ...
    >
      ...
      {DESKTOP_STEPS.map((step) => (
        <StepBox key={step.id} {...step} visible={visible[step.id]} />
      ))}
      <Arrow
        d="M 136 96 H 176"
        end="translate(184,96)"
        visible={visible.model}
        tone="model"
      />
      <Arrow
        d="M 288 96 H 328"
        end="translate(336,96)"
        visible={visible.validate}
        tone="warning"
      />
      <Arrow
        d="M 440 96 H 480"
        end="translate(488,96)"
        visible={visible.execute}
        tone="system"
      />
      <Arrow
        d="M 540 120 V 176 C 540 204 464 220 448 230"
        end="translate(440,234) rotate(155)"
        visible={visible.observe}
        tone="context"
      />
      <Arrow
        d="M 336 240 H 296"
        end="translate(288,240) rotate(180)"
        visible={visible.decide}
      />
      <Arrow
        d="M 184 240 C 112 232 84 178 84 128"
        end="translate(84,120) rotate(-90)"
        visible={visible.decide}
      />
      <Arrow
        d="M 288 264 H 408"
        end="translate(416,264)"
        visible={visible.decide}
        tone="success"
      />
      <text
        x="116"
        y="178"
        className={clsx(styles.branchLabel, visible.decide && styles.visible)}
        fill="var(--text-muted)"
      >
        iterate
      </text>
  ...
  return (
    ...
    >
      <text
        x="160"
        y="20"
        className={clsx(styles.laneLabel, visible.context && styles.visible)}
        textAnchor="middle"
        fill="var(--visual-cyan)"
      >
        harness controls model calls
      </text>
      {MOBILE_STEPS.map((step) => (
        <StepBox
          ...
          {...step}
          {...MOBILE_BOX}
          visible={visible[step.id]}
        />
      ))}
      <Arrow
        d="M 160 84 V 104"
        end="translate(160,112) rotate(90)"
        visible={visible.model}
        tone="model"
      />
      <Arrow
        d="M 160 156 V 176"
        end="translate(160,184) rotate(90)"
        visible={visible.validate}
        tone="warning"
      />
      <Arrow
        d="M 160 228 V 248"
        end="translate(160,256) rotate(90)"
        visible={visible.execute}
        tone="system"
      />
      <Arrow
        d="M 160 300 V 320"
        end="translate(160,328) rotate(90)"
        visible={visible.observe}
        tone="context"
      />
      <Arrow
        d="M 160 372 V 392"
        end="translate(160,400) rotate(90)"
        visible={visible.decide}
      />
      <Arrow
        d="M 68 422 H 32 V 62 H 60"
        end="translate(68,62)"
        visible={visible.decide}
      />
      <Arrow
        d="M 252 422 H 288"
        end="translate(296,422)"
        visible={visible.decide}
        tone="success"
      />
      <text
...
export default function HarnessLoopDiagram() {
  ...
  const visible = Object.fromEntries(
    ACTS.map(({ id }) => [id, mounted && wasReached(id)])
  ) as Visibility;
