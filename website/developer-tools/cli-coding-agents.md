...
- **Hierarchical CLAUDE.md:** Multi-level context files (global → project → subdirectory) that [merge automatically based on working directory](/context-engineering)—define coding standards at project root, override per-module, and set personal preferences globally
