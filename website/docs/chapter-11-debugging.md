...
- **Codebase**: Use ChunkHound's code research for comprehensive investigation with architectural context and cross-module relationships. For smaller codebases, [agentic search](/chapter-5-grounding#grounding-tool-1-agentic-search) (Grep, Read) works well. See [Chapter 5](/chapter-5-grounding#code-grounding-choosing-tools-by-scale) for scale guidance.
