...
As context fills, even primacy weakens. The left edge of the curve droops. Only recency survives at high fill. The dead center zone expands — at 80% fill, the middle is effectively invisible. RULER benchmark testing found that only half of models advertising 200K+ context maintained satisfactory performance at 32K tokens ([Hsieh et al., 2024](https://arxiv.org/abs/2404.06654)). Chroma's Context Rot study showed that performance degrades non-uniformly as input length grows, with coherent distractor text degrading reasoning more than obvious noise ([Chroma, 2025](https://research.trychroma.com/context-rot)). This is the constraint that context engineering works within.
...
- **Lost in the Middle** (Liu et al., 2023) — Models perform best when relevant information is at the beginning or end of context; performance drops in the middle. [arXiv:2307.03172](https://arxiv.org/abs/2307.03172)
- **Attention Sinks** (Xiao et al., 2023) — Initial tokens attract disproportionate attention regardless of semantic content. Explains the primacy mechanism. [arXiv:2309.17453](https://arxiv.org/abs/2309.17453)
- **RULER** (Hsieh et al., 2024) — Most models degrade before their advertised context window. Only half maintain satisfactory performance at 32K despite claiming 200K+. [arXiv:2404.06654](https://arxiv.org/abs/2404.06654)
- **Context Rot** (Chroma, 2025) — Performance degrades non-uniformly with input length. Coherent distractors degrade reasoning more than noise. Distractor impact amplifies with context length. [research.trychroma.com/context-rot](https://research.trychroma.com/context-rot)
- **LongICLBench** (Li et al., 2024) — Long-context LLMs show recency bias and struggle with complex tasks requiring information integration across long inputs. [arXiv:2404.02060](https://arxiv.org/abs/2404.02060)
- **LOFT** (Lee et al., 2024) — Long-context LLMs can compete with retrieval systems on simple tasks but struggle with compositional reasoning. Prompting strategy significantly impacts performance. [arXiv:2406.13121](https://arxiv.org/abs/2406.13121)
