...
import ExecutionLoopDiagram from '@site/src/components/VisualElements/ExecutionLoopDiagram';
...
Software engineering is undergoing a fundamental transformation, similar to how industrial manufacturing replaced artisan workshops.

**Manufacturing transformation:**

- **Workshop era:** Artisans shaped every piece by hand — skill bottlenecked throughput
- **Factory era:** Engineers design products, configure machines, verify output at scale
- **Result:** Orders-of-magnitude gains in throughput, consistency, and precision
...
- **Agent-driven:** Engineers design systems, configure agents, verify output at scale
- **Result:** Same gains — throughput, consistency, precision through specification

<ScrollDrivenFigure phaseEnd={0.75} caption="From artisan to factory owner.">
  <ParadigmShiftDiagram />
</ScrollDrivenFigure>

**A gain in throughput and creativity, not a loss of control.**
...
<figure>
  ...
  <figcaption>Each new token is predicted from all previous tokens in the context window — the sequence grows one token at a time, feeding back as input for the next prediction.</figcaption>
</figure>
...
<ScrollDrivenFigure phaseEnd={0.75} caption="Predict, execute, observe, repeat.">
...
**Next:** [Lesson 2: Agents Demystified](./lesson-2-how-agents-work.mdx)
