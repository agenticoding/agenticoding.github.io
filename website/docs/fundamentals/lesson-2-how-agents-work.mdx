...
<ScrollDrivenFigure phaseEnd={0.585} earlyStart caption="Perceive, reason, act, observe, verify — iterate until done.">
  <AgentLoopDiagram />
</ScrollDrivenFigure>
...
{/* phaseEnd={0.7}: spreads animation over 0.7×(vh+h) ≈ 1230px; SequenceDiagram auto-calibrates row thresholds to this value */}
<ScrollDrivenFigure phaseEnd={0.7} earlyStart caption="Everything is text flowing through a context window.">
  <SequenceDiagram
...
<ScrollDrivenFigure phaseEnd={0.6} earlyStart caption="Same code, same model — different context produces a different solution class.">
  <ContextBiasDiagram />
</ScrollDrivenFigure>
