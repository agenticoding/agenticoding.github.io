...
<DiagramFrame kicker="Agent mechanics" title="Harness design changes agent behavior" size="full" caption="Terminal-Bench reports task accuracy for submitted harnesses; holding the model group constant exposes harness effects.">
...
**Next:** [Chapter 3: Prompting 101](./chapter-3-prompting-101.mdx)
